...
- interface4.py - The interface that runs through streamlit. 
...
```
The `plot_data/`folder and `scenarios_metadata.json` files are generated after importing Argoverse 2 sensor folder in the Streamlit interface. 